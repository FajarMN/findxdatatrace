...
$cybint = mysqli_query($conn, "SELECT * FROM news WHERE category = 'Cybint'");
...
<head>
    ...
    <title>Berita Cybint - FINDxDataTrace</title>
                    ...
                    <?php while ($row = mysqli_fetch_assoc($cybint)) : ?>
                        <div class="news-section">
                            <div class="news-image">
                                <img class="news-img" src="../../admin/news/uploads/<?php echo $row['img'] ?>" alt="Image" style="width: 500px; height: 300px; object-fit: cover;">
                            </div>
                            <div class="news-text">
